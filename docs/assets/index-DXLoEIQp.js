...
`;var Sf=document.querySelector(`#scene`);if(!Sf)throw Error(`Missing required DOM elements`);var Cf=e=>`/HTML/models/${e}`,wf=new Vu({canvas:Sf,antialias:!0});wf.setPixelRatio(Math.min(window.devicePixelRatio,2)),wf.setSize(window.innerWidth,window.innerHeight),wf.shadowMap.enabled=!0,wf.shadowMap.type=2,wf.toneMapping=4,wf.toneMappingExposure=1.08;var Tf=new Nn;Tf.background=new Y(131844),Tf.fog=new Mn(131844,20,42);var Ef=new Js(wf);Tf.environment=Ef.fromScene(new Wd,.6).texture,Ef.dispose();var Df=new Uo(44,window.innerWidth/window.innerHeight,.1,100),Of=new G(0,2.15,17.7),kf=new G(0,-1.1,0);Df.position.copy(Of),Df.lookAt(kf);var Af=new Zo(10533119,.42);Tf.add(Af);var jf=new jo(10406399,659222,.36);Tf.add(jf);var Mf=new Xo(14214911,.95);Mf.position.set(7,10,6),Mf.castShadow=!0,Mf.shadow.mapSize.set(1024,1024),Tf.add(Mf);var Nf=new qo(7256063,1.35,22);Nf.position.set(-8,3,-8),Tf.add(Nf);var Pf=new Go(12180735,2.1,30,Math.PI/8,.42,1.05);Pf.position.set(14,5.1,2.8),Pf.castShadow=!0,Pf.shadow.mapSize.set(1024,1024),Tf.add(Pf),Tf.add(Pf.target);var Ff=new qo(4183807,1.35,18);Ff.position.set(12.5,.7,-6),Tf.add(Ff);var If=new Go(14740479,.58,34,Math.PI/5,.64,1.12);If.position.set(0,10.8,3.2),If.castShadow=!0,If.shadow.mapSize.set(1024,1024),If.target.position.set(0,-1.4,2.8),Tf.add(If),Tf.add(If.target);var Lf=new Go(16770239,.3,22,Math.PI/5,.56,1.25);Lf.position.set(-8.2,4.7,7.2),Lf.target.position.set(-.2,-2.7,4.4),Tf.add(Lf),Tf.add(Lf.target);var Rf=new Go(10147839,1.55,20,Math.PI/6,.7,1.1);Rf.position.set(11.8,2.2,2.3),Tf.add(Rf),Tf.add(Rf.target);var zf=new X(new oa(18,80),new Ja({color:658705,roughness:.92,metalness:.1}));zf.rotation.x=-Math.PI/2,zf.position.y=-4.05,zf.receiveShadow=!0,Tf.add(zf);for(let e=0;e<3;e+=1){let t=new Ki(new oa(7+e*3.4,128),new Ni({color:2568509,transparent:!0,opacity:.5-e*.12}));t.rotation.x=-Math.PI/2,t.position.y=-3.98,Tf.add(t)}var Bf=new Dr,Vf=new Float32Array(1800);for(let e=0;e<Vf.length;e+=3)Vf[e]=(Math.random()-.5)*65,Vf[e+1]=(Math.random()-.1)*32,Vf[e+2]=(Math.random()-.5)*65;Bf.setAttribute(`position`,new fr(Vf,3));var Hf=new Qi(Bf,new qi({color:15201791,size:.07,transparent:!0,opacity:.7}));Tf.add(Hf);var Uf=new wn;Uf.position.set(-15.5,8.8,-24),Tf.add(Uf);var Wf=new Vr({color:11127274,transparent:!0,opacity:.2}),Gf=new X(new Ia(3.4,32,32),Wf);Uf.add(Gf);var Kf=new qo(13229567,.92,42);Uf.add(Kf),new Gu().load(Cf(`luna_earths_companion.glb`),e=>{let t=e.scene;t.traverse(e=>{e instanceof X&&(e.castShadow=!1,e.receiveShadow=!1,Array.isArray(e.material)?e.material.forEach(e=>{e instanceof Ja&&(e.envMapIntensity=1.35,e.roughness=Math.min(1,e.roughness*1.05))}):e.material instanceof Ja&&(e.material.envMapIntensity=1.35,e.material.roughness=Math.min(1,e.material.roughness*1.05)))});let n=new Jn().setFromObject(t),r=new G,i=new G;n.getSize(r),n.getCenter(i);let a=5.2/Math.max(r.x,r.y,r.z,.001);t.scale.setScalar(a),t.position.sub(i.multiplyScalar(a)),t.rotation.y=Math.PI*.2,Uf.add(t)},void 0,()=>{let e=new X(new Ia(1.7,40,40),new Ja({color:13489374,roughness:.95,metalness:.02,emissive:4938868,emissiveIntensity:.18}));Uf.add(e)});var qf=new wn;qf.position.y=-.75,qf.rotation.set(.02,0,0),Tf.add(qf);var Jf=new Ja({color:14276560,roughness:.76,metalness:.08}),Yf=new Ja({color:1779509,emissive:4183807,emissiveIntensity:.8,roughness:.3,metalness:.2}),Xf=new Ja({color:2041651,roughness:.4,metalness:.32}),Zf=new Ja({color:922654,roughness:.45,metalness:.35}),Qf=new Ja({color:2107443,roughness:.48,metalness:.26}),$f=new wn;$f.position.set(0,2.34,-.82),$f.scale.setScalar(1.14),qf.add($f);var ep=new X(new aa(9.6,5.8,.55),Xf);ep.castShadow=!0,$f.add(ep);var tp=new X(new aa(8.9,5.15,.14),Zf);tp.position.set(0,0,.29),tp.castShadow=!0,$f.add(tp);var np=new wn;np.position.set(0,-3.3,-.05),$f.add(np);var rp=new X(new aa(.75,2.15,.52),Zf);rp.castShadow=!0,np.add(rp);var ip=new X(new sa(1.8,2.1,.24,40),Zf);ip.position.set(0,-1.2,.7),ip.castShadow=!0,np.add(ip);var ap=document.createElement(`canvas`);ap.width=1280,ap.height=720;var op=ap.getContext(`2d`);if(!op)throw Error(`2D context unavailable`);var sp=op,cp=new ta(ap);cp.colorSpace=ze,cp.minFilter=s;var lp=new X(new Fa(8.42,4.73),new Vr({map:cp,toneMapped:!1}));lp.position.set(0,0,.48),lp.renderOrder=2,$f.add(lp);var up=new wn;up.position.set(10.95,-1.62,-3.2),up.rotation.y=-.34,up.scale.setScalar(1.1),qf.add(up),Pf.target=up;var dp=new wn;up.add(dp);var fp=new qo(5692927,1.45,14);fp.position.set(-.8,1.1,.9),up.add(fp);var pp=new X(new oa(1.55,28),new Vr({color:329481,transparent:!0,opacity:.42}));pp.rotation.x=-Math.PI/2,pp.position.set(0,-3.45,0),up.add(pp);var mp=new Gu;mp.load(Cf(`pc_model.glb`),e=>{let t=e.scene,n=Math.PI*.86;t.traverse(e=>{e instanceof X&&(e.castShadow=!0,e.receiveShadow=!0,Array.isArray(e.material)?e.material.forEach(e=>{e instanceof Ja&&(e.envMapIntensity=1.7,e.roughness=Math.min(1,e.roughness*.92),e.metalness=Math.min(1,e.metalness*.95),e.color.multiplyScalar(1.1))}):e.material instanceof Ja&&(e.material.envMapIntensity=1.7,e.material.roughness=Math.min(1,e.material.roughness*.92),e.material.metalness=Math.min(1,e.material.metalness*.95),e.material.color.multiplyScalar(1.1)))});let r=new Jn().setFromObject(t),i=new G,a=new G;r.getSize(i),r.getCenter(a);let o=7.8/Math.max(i.y,.001);t.scale.setScalar(o),t.position.sub(a.multiplyScalar(o)),t.position.y+=-3.22+i.y*o/2,t.rotation.y=n,dp.add(t)},void 0,e=>{console.error(`Failed to load PC GLB model:`,e);let t=new X(new aa(3.3,7.2,6),Qf);t.castShadow=!0,t.position.y=-.2,dp.add(t)}),Rf.target=up;var hp=new wn;hp.position.set(0,-3.06,4.68),hp.rotation.x=.08,hp.scale.setScalar(.86),qf.add(hp);var gp=new Ja({color:1711914,roughness:.52,metalness:.26}),_p=new Ja({color:2765120,roughness:.45,metalness:.22}),vp=new X(new aa(13.4,.6,5.35),gp);vp.castShadow=!0,hp.add(vp);var yp=new X(new aa(12.75,.08,4.75),_p);yp.position.set(0,.34,-.08),hp.add(yp);var bp=new X(new aa(13.25,.22,.3),_p);bp.position.set(0,.2,2.48),hp.add(bp);var xp=new Ja({color:856860,emissive:4048127,emissiveIntensity:.02,roughness:.4,metalness:.12}),Sp=new X(new aa(12.25,.05,.08),xp);Sp.position.set(0,-.2,2.62),hp.add(Sp);var Cp=new Ja({color:12173775,roughness:.62,metalness:.04}),wp=new Ja({color:12751195,roughness:.58,metalness:.06}),Tp=new Ja({color:2841753,roughness:.54,metalness:.08}),Ep=new Map,Dp=[],Op=new bs,kp=new W,Ap=new Map;function jp(e){return e===`warm`?wp:e===`cool`?Tp:Cp}function Mp(e){return af[e]??e.replace(`Key`,``)}function Np(e,t){let n=`${t}:${e}`,r=Ap.get(n);if(r)return r;let i=document.createElement(`canvas`);i.width=256,i.height=256;let a=i.getContext(`2d`);if(!a)return jp(t);let o=t===`warm`?`#c99863`:t===`cool`?`#2f67ac`:`#bcc5d3`,c=t===`cool`?`#f2f8ff`:`#1f2a38`;a.fillStyle=o,a.fillRect(0,0,256,256),a.strokeStyle=`rgba(255, 255, 255, 0.12)`,a.lineWidth=6,a.strokeRect(9,9,238,238),a.fillStyle=c,a.font=`bold 42px "Segoe UI", Arial, sans-serif`,a.textAlign=`center`,a.textBaseline=`middle`;let l=e.split(`
`);l.length===1?a.fillText(l[0],128,132):(a.font=`bold 36px "Segoe UI", Arial, sans-serif`,l.forEach((e,t)=>{a.fillText(e,128,106+t*54)}));let u=new ta(i);u.colorSpace=ze,u.anisotropy=wf.capabilities.getMaxAnisotropy(),u.minFilter=s;let d=new Ja({map:u,roughness:.38,metalness:.08});return Ap.set(n,d),d}function Pp(e,t,n,r=1,i=`normal`){let a=r*.45,o=jp(i),s=[o,o,Np(Mp(e),i),o,o,o],c=new X(new aa(a,.16,.38),s);c.castShadow=!0,c.position.set(t+a/2,.43,n),c.userData.restY=c.position.y,c.userData.press=0,Dp.push(c);let l=Ep.get(e)??[];l.push(c),Ep.set(e,l),hp.add(c)}of.forEach((e,t)=>{let n=lf.primaryStartX,r=lf.rowStart+t*lf.rowDepth;e.forEach(e=>{Pp(e.code,n,r,e.width??1,e.tone??`normal`),n+=(e.width??1)*lf.unit+lf.gap})}),sf.forEach((e,t)=>{let n=e.reduce((e,t)=>e+(t.width??1)*lf.unit+lf.gap,-lf.gap),r=lf.navCenterX-n/2,i=lf.rowStart+t*lf.rowDepth;e.forEach(e=>{Pp(e.code,r,i,e.width??1,e.tone??`normal`),r+=(e.width??1)*lf.unit+lf.gap})}),cf.forEach((e,t)=>{let n=e.reduce((e,t)=>e+(t.width??1)*lf.unit+lf.gap,-lf.gap),r=lf.numpadCenterX-n/2,i=lf.rowStart+t*lf.rowDepth;e.forEach(e=>{Pp(e.code===`NumpadAddGhost`?`NumpadAdd`:e.code===`NumpadEnterGhost`?`NumpadEnter`:e.code,r,i,e.width??1,e.tone??`normal`),r+=(e.width??1)*lf.unit+lf.gap})});var Fp=new wn;Fp.position.set(6.7,-2.96,4.35),qf.add(Fp);var Ip=new wn;Fp.add(Ip);var Lp=null,Rp=[],zp=new WeakMap;mp.load(Cf(`pc_mouse_type-r.glb`),e=>{let t=e.scene;t.traverse(e=>{e instanceof X&&(e.castShadow=!0,e.receiveShadow=!0,Array.isArray(e.material)?e.material.forEach(e=>{e instanceof Ja&&(e.envMapIntensity=1.25,e.roughness=Math.min(1,e.roughness*.96))}):e.material instanceof Ja&&(e.material.envMapIntensity=1.25,e.material.roughness=Math.min(1,e.material.roughness*.96)));let t=e.name.toLowerCase();(t.includes(`wheel`)||t.includes(`scroll`))&&(Lp=e),(t.includes(`left`)||t.includes(`right`)||t.includes(`button`)||t.includes(`click`))&&(Rp.push(e),zp.set(e,e.position.y))});let n=new Jn().setFromObject(t),r=new G,i=new G;n.getSize(r),n.getCenter(i);let a=1.95/Math.max(r.z,.001);t.scale.setScalar(a),t.position.sub(i.multiplyScalar(a)),t.position.y+=r.y*a/2+.02,t.rotation.y=Math.PI*1.9,t.rotation.x=-.02,Ip.add(t)},void 0,()=>{let e=new X(new Ia(.63,28,20),Jf);e.scale.set(1.06,.62,1.3),e.castShadow=!0,e.position.y=.42,Ip.add(e)});var Bp=new Ja({color:2040877,roughness:.85,metalness:.08}),Vp=new X(new La(new _a([new G(.5,-3.1,4.9),new G(2.3,-3.2,5.6),new G(4.1,-3.05,5.05),new G(6,-2.95,4.35)]),48,.04,8,!1),Bp);Vp.castShadow=!0,qf.add(Vp);var Hp=new yf,Up=!0,Wp=!1,Gp=0,Kp=0,qp=0,Jp=0;function Yp(){let e=sp,{width:t,height:n}=ap,r=t-104,i=n-84,a=e.createLinearGradient(0,0,0,n);a.addColorStop(0,`#cad8e2`),a.addColorStop(.5,`#9cc1d6`),a.addColorStop(1,`#5f8ea8`),e.fillStyle=a,e.fillRect(0,0,t,n);for(let r=0;r<n;r+=4)e.fillStyle=r%8==0?`rgba(0, 0, 0, 0.07)`:`rgba(255, 255, 255, 0.03)`,e.fillRect(0,r,t,2);e.fillStyle=`rgba(9, 23, 35, 0.8)`,e.fillRect(52,42,r,i);let o=Hp.getViewModel();if(e.font=`26px "Courier New", monospace`,e.fillStyle=`#9ce8ff`,e.fillText(o.title,76,80),e.font=`19px "Courier New", monospace`,e.fillStyle=`#7fd3ff`,e.fillText(o.statusLabel,52+r-238,80),o.mode===`browser`){let t=r-40,n=i-130;if(e.fillStyle=`rgba(8, 16, 26, 0.92)`,e.fillRect(72,108,t,n),e.fillStyle=`rgba(110, 170, 214, 0.3)`,e.fillRect(72,108,t,36),e.strokeStyle=`rgba(150, 220, 255, 0.32)`,e.strokeRect(72,108,t,n),e.fillStyle=`#cfeeff`,e.font=`18px "Courier New", monospace`,e.fillText(o.windowTitle,86,132),e.fillStyle=`#91d9ff`,e.font=`16px "Courier New", monospace`,e.fillText(o.windowPath,86,164),e.fillStyle=`#d7f9ff`,e.font=`18px "Courier New", monospace`,o.windowLines.forEach((t,n)=>{e.fillText(t,86,194+n*28)}),e.fillStyle=`#ffd394`,e.fillText(o.prompt,86,108+n-16),Up){let t=`> ${o.prompt.slice(2,2+o.cursorIndex)}`,r=e.measureText(t);e.fillRect(88+r.width,108+n-31,10,16)}}else{let t=[...o.lines,o.prompt];if(e.font=`17px "Consolas", "Cascadia Code", "Courier New", monospace`,e.fillStyle=`#d7f9ff`,t.forEach((t,n)=>{e.fillText(t,76,118+n*26)}),Up){let n=`> ${o.prompt.slice(2,2+o.cursorIndex)}`,r=e.measureText(n);e.fillRect(78+r.width,98+(t.length-1)*26,12,18)}}e.fillStyle=`rgba(255, 255, 255, 0.06)`,e.beginPath(),e.ellipse(t/2,n/2,t*.5,n*.44,0,0,Math.PI*2),e.fill(),cp.needsUpdate=!0}window.addEventListener(`keydown`,e=>{e.code===`Space`&&e.preventDefault();let t=Ep.get(e.code);if(t&&t.forEach(e=>{e.userData.press=1}),e.key===`ArrowLeft`){e.preventDefault(),Hp.moveCursorLeft(),Yp();return}if(e.key===`ArrowRight`){e.preventDefault(),Hp.moveCursorRight(),Yp();return}if(e.key===`ArrowUp`){e.preventDefault(),Hp.historyPrev(),Yp();return}if(e.key===`ArrowDown`){e.preventDefault(),Hp.historyNext(),Yp();return}if(e.key===`Home`){e.preventDefault(),Hp.moveCursorHome(),Yp();return}if(e.key===`End`){e.preventDefault(),Hp.moveCursorEnd(),Yp();return}if(e.key===`Backspace`){xf(),Hp.backspace(),Yp();return}if(e.key===`Delete`){xf(),Hp.delete(),Yp();return}if(e.key===`Enter`){if(e.repeat)return;xf(),Hp.submit(),Yp();return}e.key.length===1&&!e.metaKey&&!e.ctrlKey&&!e.altKey&&(xf(),Hp.insertCharacter(e.key),Yp())}),window.addEventListener(`keyup`,e=>{let t=Ep.get(e.code);t&&t.forEach(e=>{e.userData.press=0})}),window.addEventListener(`pointermove`,e=>{qp=e.clientX/window.innerWidth-.5,Jp=e.clientY/window.innerHeight-.5}),window.addEventListener(`pointerdown`,e=>{Wp=!0,Rp.forEach(e=>{let t=zp.get(e)??e.position.y;e.position.y=t-.01}),kp.x=e.clientX/window.innerWidth*2-1,kp.y=-(e.clientY/window.innerHeight)*2+1,Op.setFromCamera(kp,Df);let t=Op.intersectObjects(Dp,!1);if(t.length>0){let e=t[0].object;for(let[t,n]of Ep.entries())if(n.includes(e)){xf(),n.forEach(e=>{e.userData.press=1,setTimeout(()=>{e.userData.press=0},100)});let e=Mp(t),r=``;if(t===`Enter`)Hp.submit();else if(t===`Backspace`)Hp.backspace();else if(t===`Space`)Hp.insertCharacter(` `);else if(t===`Tab`)Hp.insertCharacter(`  `);else if(e.length===1)r=e,Hp.insertCharacter(r);else if(e.match(/^[0-9]$/))Hp.insertCharacter(e);else{let e={Comma:`,`,Period:`.`,Slash:`/`,Semicolon:`;`,Quote:`'`,BracketLeft:`[`,BracketRight:`]`,Backslash:`\\`,Minus:`-`,Equal:`=`,Backquote:"`"};e[t]&&Hp.insertCharacter(e[t])}Yp();break}}}),window.addEventListener(`pointerup`,()=>{Wp=!1,Rp.forEach(e=>{let t=zp.get(e)??e.position.y;e.position.y=t})}),window.addEventListener(`wheel`,e=>{Gp+=e.deltaY*4e-4}),window.addEventListener(`resize`,()=>{Df.aspect=window.innerWidth/window.innerHeight,Df.updateProjectionMatrix(),wf.setSize(window.innerWidth,window.innerHeight),wf.setPixelRatio(Math.min(window.devicePixelRatio,2)),$p.setSize(window.innerWidth,window.innerHeight),$p.setPixelRatio(Math.min(window.devicePixelRatio,2)),Qp.setSize(window.innerWidth,window.innerHeight)}),setInterval(()=>{Up=!Up,Yp()},460),Yp();var Xp=new Cs,Zp=new tf(Tf,Df),Qp=new rf(new W(window.innerWidth,window.innerHeight),0,.2,1.02),$p=new ef(wf);$p.addPass(Zp),$p.addPass(Qp);function em(){let e=Xp.getElapsedTime();Df.position.copy(Of),Df.lookAt(kf),Dp.forEach(e=>{let t=Number(e.userData.restY)-Number(e.userData.press)*.08;e.position.y=Dt.lerp(e.position.y,t,.18)});let t=6.35+qp*1.2,n=4.2+Jp*.9,r=hp.position.x+13.4*.86/2+.95;Fp.position.x=Dt.lerp(Fp.position.x,Math.max(t,r),.1),Fp.position.z=Dt.lerp(Fp.position.z,n,.1),Fp.rotation.z=Dt.lerp(Fp.rotation.z,qp*-.25,.1),Fp.rotation.x=Dt.lerp(Fp.rotation.x,(Wp?.14:.03)+Jp*.12,.15),Kp=Dt.lerp(Kp,Gp,.14),Lp&&(Lp.rotation.x=Kp*1.4),Ip.rotation.y=Kp*.08;let i=.45+(Math.sin(e*2.2)*.5+.5)*.95,a=.5+(Math.sin(e*.55+.7)*.5+.5)*.7;Uf.rotation.y+=5e-4,Gf.scale.setScalar(1+a*.08),Wf.opacity=.16+a*.12,Kf.intensity=.78+a*.82,Yf.emissiveIntensity=i,fp.intensity=1+(Math.sin(e*2.7+.5)*.5+.5)*1.05,Ff.intensity=1.25+(Math.sin(e*2.4+1.8)*.5+.5)*.95,Rf.intensity=1+(Math.sin(e*1.8+.9)*.5+.5)*.32,xp.emissiveIntensity=.02,Hf.rotation.y+=8e-4,Hf.rotation.x=Math.sin(e*.1)*.06,$p.render(),requestAnimationFrame(em)}em();