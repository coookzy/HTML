	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};$d.BlurDirectionX=new W(1,0),$d.BlurDirectionY=new W(0,1),document.querySelector(`#app`).innerHTML=`
...
`;var ef=document.querySelector(`#scene`),tf=document.querySelector(`#typed-value`);if(!ef||!tf)throw Error(`Missing required DOM elements`);var nf=tf,rf=e=>`/HTML/models/${e}`,af=new Lu({canvas:ef,antialias:!0});af.setPixelRatio(Math.min(window.devicePixelRatio,2)),af.setSize(window.innerWidth,window.innerHeight),af.shadowMap.enabled=!0,af.shadowMap.type=2,af.toneMapping=4,af.toneMappingExposure=1.08;var of=new Nn;of.background=new Y(131844),of.fog=new Mn(131844,20,42);var sf=new Ws(af);of.environment=sf.fromScene(new Bd,.6).texture,sf.dispose();var cf=new Uo(44,window.innerWidth/window.innerHeight,.1,100),lf=new G(0,2.15,17.7),uf=new G(0,-1.1,0);cf.position.copy(lf),cf.lookAt(uf);var df=new Zo(10533119,.42);of.add(df);var ff=new jo(10406399,659222,.36);of.add(ff);var pf=new Xo(14214911,.95);pf.position.set(7,10,6),pf.castShadow=!0,pf.shadow.mapSize.set(1024,1024),of.add(pf);var mf=new qo(7256063,1.35,22);mf.position.set(-8,3,-8),of.add(mf);var hf=new Go(12180735,2.1,30,Math.PI/8,.42,1.05);hf.position.set(14,5.1,2.8),hf.castShadow=!0,hf.shadow.mapSize.set(1024,1024),of.add(hf),of.add(hf.target);var gf=new qo(4183807,1.35,18);gf.position.set(12.5,.7,-6),of.add(gf);var _f=new Go(14740479,.58,34,Math.PI/5,.64,1.12);_f.position.set(0,10.8,3.2),_f.castShadow=!0,_f.shadow.mapSize.set(1024,1024),_f.target.position.set(0,-1.4,2.8),of.add(_f),of.add(_f.target);var vf=new Go(16770239,.3,22,Math.PI/5,.56,1.25);vf.position.set(-8.2,4.7,7.2),vf.target.position.set(-.2,-2.7,4.4),of.add(vf),of.add(vf.target);var yf=new Go(10147839,1.55,20,Math.PI/6,.7,1.1);yf.position.set(11.8,2.2,2.3),of.add(yf),of.add(yf.target);var bf=new X(new oa(18,80),new Ja({color:658705,roughness:.92,metalness:.1}));bf.rotation.x=-Math.PI/2,bf.position.y=-4.05,bf.receiveShadow=!0,of.add(bf);for(let e=0;e<3;e+=1){let t=new Ki(new oa(7+e*3.4,128),new Ni({color:2568509,transparent:!0,opacity:.5-e*.12}));t.rotation.x=-Math.PI/2,t.position.y=-3.98,of.add(t)}var xf=new Dr,Sf=new Float32Array(1800);for(let e=0;e<Sf.length;e+=3)Sf[e]=(Math.random()-.5)*65,Sf[e+1]=(Math.random()-.1)*32,Sf[e+2]=(Math.random()-.5)*65;xf.setAttribute(`position`,new fr(Sf,3));var Cf=new Qi(xf,new qi({color:15201791,size:.07,transparent:!0,opacity:.7}));of.add(Cf);var wf=new wn;wf.position.set(-15.5,8.8,-24),of.add(wf);var Tf=new Vr({color:11127274,transparent:!0,opacity:.2}),Ef=new X(new Ia(3.4,32,32),Tf);wf.add(Ef);var Df=new qo(13229567,.92,42);wf.add(Df),new Vu().load(rf(`luna_earths_companion.glb`),e=>{let t=e.scene;t.traverse(e=>{e instanceof X&&(e.castShadow=!1,e.receiveShadow=!1,Array.isArray(e.material)?e.material.forEach(e=>{e instanceof Ja&&(e.envMapIntensity=1.35,e.roughness=Math.min(1,e.roughness*1.05))}):e.material instanceof Ja&&(e.material.envMapIntensity=1.35,e.material.roughness=Math.min(1,e.material.roughness*1.05)))});let n=new Jn().setFromObject(t),r=new G,i=new G;n.getSize(r),n.getCenter(i);let a=5.2/Math.max(r.x,r.y,r.z,.001);t.scale.setScalar(a),t.position.sub(i.multiplyScalar(a)),t.rotation.y=Math.PI*.2,wf.add(t)},void 0,()=>{let e=new X(new Ia(1.7,40,40),new Ja({color:13489374,roughness:.95,metalness:.02,emissive:4938868,emissiveIntensity:.18}));wf.add(e)});var Of=new wn;Of.position.y=-.75,Of.rotation.set(.02,0,0),of.add(Of);var kf=new Ja({color:14276560,roughness:.76,metalness:.08}),Af=new Ja({color:1779509,emissive:4183807,emissiveIntensity:.8,roughness:.3,metalness:.2}),jf=new Ja({color:2041651,roughness:.4,metalness:.32}),Mf=new Ja({color:922654,roughness:.45,metalness:.35}),Nf=new Ja({color:2107443,roughness:.48,metalness:.26}),Pf=new wn;Pf.position.set(0,2.34,-.82),Pf.scale.setScalar(1.14),Of.add(Pf);var Ff=new X(new aa(9.6,5.8,.55),jf);Ff.castShadow=!0,Pf.add(Ff);var If=new X(new aa(8.9,5.15,.14),Mf);If.position.set(0,0,.29),If.castShadow=!0,Pf.add(If);var Lf=new wn;Lf.position.set(0,-3.3,-.05),Pf.add(Lf);var Rf=new X(new aa(.75,2.15,.52),Mf);Rf.castShadow=!0,Lf.add(Rf);var zf=new X(new sa(1.8,2.1,.24,40),Mf);zf.position.set(0,-1.2,.7),zf.castShadow=!0,Lf.add(zf);var Bf=document.createElement(`canvas`);Bf.width=1280,Bf.height=720;var Vf=Bf.getContext(`2d`);if(!Vf)throw Error(`2D context unavailable`);var Hf=Vf,Uf=new ta(Bf);Uf.colorSpace=ze,Uf.minFilter=s;var Wf=new X(new Fa(8.42,4.73),new Vr({map:Uf,toneMapped:!1}));Wf.position.set(0,0,.48),Wf.renderOrder=2,Pf.add(Wf);var Gf=new wn;Gf.position.set(10.95,-1.62,-3.2),Gf.rotation.y=-.34,Gf.scale.setScalar(1.1),Of.add(Gf),hf.target=Gf;var Kf=new wn;Gf.add(Kf);var qf=new qo(5692927,1.45,14);qf.position.set(-.8,1.1,.9),Gf.add(qf);var Jf=new X(new oa(1.55,28),new Vr({color:329481,transparent:!0,opacity:.42}));Jf.rotation.x=-Math.PI/2,Jf.position.set(0,-3.45,0),Gf.add(Jf);var Yf=new Vu;Yf.load(rf(`pc_model.glb`),e=>{let t=e.scene,n=Math.PI*.86;t.traverse(e=>{e instanceof X&&(e.castShadow=!0,e.receiveShadow=!0,Array.isArray(e.material)?e.material.forEach(e=>{e instanceof Ja&&(e.envMapIntensity=1.7,e.roughness=Math.min(1,e.roughness*.92),e.metalness=Math.min(1,e.metalness*.95),e.color.multiplyScalar(1.1))}):e.material instanceof Ja&&(e.material.envMapIntensity=1.7,e.material.roughness=Math.min(1,e.material.roughness*.92),e.material.metalness=Math.min(1,e.material.metalness*.95),e.material.color.multiplyScalar(1.1)))});let r=new Jn().setFromObject(t),i=new G,a=new G;r.getSize(i),r.getCenter(a);let o=7.8/Math.max(i.y,.001);t.scale.setScalar(o),t.position.sub(a.multiplyScalar(o)),t.position.y+=-3.22+i.y*o/2,t.rotation.y=n,Kf.add(t)},void 0,e=>{console.error(`Failed to load PC GLB model:`,e);let t=new X(new aa(3.3,7.2,6),Nf);t.castShadow=!0,t.position.y=-.2,Kf.add(t)}),yf.target=Gf;var Xf=new wn;Xf.position.set(0,-3.06,4.68),Xf.rotation.x=.08,Xf.scale.setScalar(.86),Of.add(Xf);var Zf=new Ja({color:1711914,roughness:.52,metalness:.26}),Qf=new Ja({color:2765120,roughness:.45,metalness:.22}),$f=new X(new aa(13.4,.6,5.35),Zf);$f.castShadow=!0,Xf.add($f);var ep=new X(new aa(12.75,.08,4.75),Qf);ep.position.set(0,.34,-.08),Xf.add(ep);var tp=new X(new aa(13.25,.22,.3),Qf);tp.position.set(0,.2,2.48),Xf.add(tp);var np=new Ja({color:856860,emissive:4048127,emissiveIntensity:.02,roughness:.4,metalness:.12}),rp=new X(new aa(12.25,.05,.08),np);rp.position.set(0,-.2,2.62),Xf.add(rp);var ip=new Ja({color:12173775,roughness:.62,metalness:.04}),ap=new Ja({color:12751195,roughness:.58,metalness:.06}),op=new Ja({color:2841753,roughness:.54,metalness:.08}),sp=new Map,cp=[],lp=new Map,up={Escape:`ESC`,Backquote:"` ~",Minus:`- _`,Equal:`= +`,Backspace:`BACKSPACE`,Tab:`TAB`,BracketLeft:`[ {`,BracketRight:`] }`,Backslash:`\\ |`,CapsLock:`CAPS`,Semicolon:`; :`,Quote:`' "`,Enter:`ENTER`,ShiftLeft:`SHIFT`,ShiftRight:`SHIFT`,Comma:`, <`,Period:`. >`,Slash:`/ ?`,ControlLeft:`CTRL`,ControlRight:`CTRL`,MetaLeft:`WIN`,MetaRight:`WIN`,AltLeft:`ALT`,AltRight:`ALT`,Space:`SPACE`,ContextMenu:`MENU`,Insert:`INS`,Delete:`DEL`,Home:`HOME`,End:`END`,PageUp:`PGUP`,PageDown:`PGDN`,ArrowUp:`UP`,ArrowLeft:`LEFT`,ArrowDown:`DOWN`,ArrowRight:`RIGHT`,NumLock:`NUM`,NumpadDivide:`/`,NumpadMultiply:`*`,NumpadSubtract:`-`,NumpadAdd:`+`,NumpadDecimal:`.`,NumpadEnter:`ENTER`};for(let e=1;e<=12;e+=1)up[`F${e}`]=`F${e}`;for(let e=0;e<=9;e+=1){let t=e===0?`Digit0`:`Digit${e}`,n=[`)`,`!`,`@`,`#`,`$`,`%`,`^`,`&`,`*`,`(`][e];up[t]=`${e} ${n}`}for(let e=0;e<=9;e+=1){let t=`Numpad${e}`;up[t]=`${e}`}for(let e=65;e<=90;e+=1){let t=String.fromCharCode(e);up[`Key${t}`]=t}function dp(e){return e===`warm`?ap:e===`cool`?op:ip}function fp(e){return up[e]??e.replace(`Key`,``)}function pp(e,t){let n=`${t}:${e}`,r=lp.get(n);if(r)return r;let i=document.createElement(`canvas`);i.width=256,i.height=256;let a=i.getContext(`2d`);if(!a)return dp(t);let o=t===`warm`?`#c99863`:t===`cool`?`#2f67ac`:`#bcc5d3`,c=t===`cool`?`#f2f8ff`:`#1f2a38`;a.fillStyle=o,a.fillRect(0,0,256,256),a.strokeStyle=`rgba(255, 255, 255, 0.12)`,a.lineWidth=6,a.strokeRect(9,9,238,238),a.fillStyle=c,a.font=`bold 42px "Segoe UI", Arial, sans-serif`,a.textAlign=`center`,a.textBaseline=`middle`;let l=e.split(`
`);l.length===1?a.fillText(l[0],128,132):(a.font=`bold 36px "Segoe UI", Arial, sans-serif`,l.forEach((e,t)=>{a.fillText(e,128,106+t*54)}));let u=new ta(i);u.colorSpace=ze,u.anisotropy=af.capabilities.getMaxAnisotropy(),u.minFilter=s;let d=new Ja({map:u,roughness:.38,metalness:.08});return lp.set(n,d),d}function mp(e,t,n,r=1,i=`normal`){let a=r*.45,o=dp(i),s=[o,o,pp(fp(e),i),o,o,o],c=new X(new aa(a,.16,.38),s);c.castShadow=!0,c.position.set(t+a/2,.43,n),c.userData.restY=c.position.y,c.userData.press=0,cp.push(c);let l=sp.get(e)??[];l.push(c),sp.set(e,l),Xf.add(c)}var hp=[[{code:`Escape`,tone:`warm`},{code:`F1`},{code:`F2`},{code:`F3`},{code:`F4`},{code:`F5`},{code:`F6`},{code:`F7`},{code:`F8`},{code:`F9`},{code:`F10`},{code:`F11`},{code:`F12`}],[{code:`Backquote`},{code:`Digit1`},{code:`Digit2`},{code:`Digit3`},{code:`Digit4`},{code:`Digit5`},{code:`Digit6`},{code:`Digit7`},{code:`Digit8`},{code:`Digit9`},{code:`Digit0`},{code:`Minus`},{code:`Equal`},{code:`Backspace`,width:1.9}],[{code:`Tab`,width:1.45},{code:`KeyQ`},{code:`KeyW`},{code:`KeyE`},{code:`KeyR`},{code:`KeyT`},{code:`KeyY`},{code:`KeyU`},{code:`KeyI`},{code:`KeyO`},{code:`KeyP`},{code:`BracketLeft`},{code:`BracketRight`},{code:`Backslash`,width:1.45}],[{code:`CapsLock`,width:1.85},{code:`KeyA`},{code:`KeyS`},{code:`KeyD`},{code:`KeyF`},{code:`KeyG`},{code:`KeyH`},{code:`KeyJ`},{code:`KeyK`},{code:`KeyL`},{code:`Semicolon`},{code:`Quote`},{code:`Enter`,width:2.25,tone:`cool`}],[{code:`ShiftLeft`,width:2.25},{code:`KeyZ`},{code:`KeyX`},{code:`KeyC`},{code:`KeyV`},{code:`KeyB`},{code:`KeyN`},{code:`KeyM`},{code:`Comma`},{code:`Period`},{code:`Slash`},{code:`ShiftRight`,width:2.6}],[{code:`ControlLeft`,width:1.35},{code:`MetaLeft`,width:1.35},{code:`AltLeft`,width:1.35},{code:`Space`,width:5,tone:`cool`},{code:`AltRight`,width:1.35},{code:`MetaRight`,width:1.35},{code:`ContextMenu`,width:1.35},{code:`ControlRight`,width:1.35}]],gp=.45,_p=.08,vp=.64,yp=-1.86,bp=-5.66;hp.forEach((e,t)=>{let n=bp,r=yp+t*vp;e.forEach(e=>{mp(e.code,n,r,e.width??1,e.tone??`normal`),n+=(e.width??1)*gp+_p})}),[[{code:`Insert`},{code:`Home`},{code:`PageUp`}],[{code:`Delete`},{code:`End`},{code:`PageDown`}],[{code:`ArrowUp`}],[{code:`ArrowLeft`},{code:`ArrowDown`},{code:`ArrowRight`}]].forEach((e,t)=>{let n=3.05-e.reduce((e,t)=>e+(t.width??1)*gp+_p,-_p)/2,r=yp+t*vp;e.forEach(e=>{mp(e.code,n,r,e.width??1,e.tone??`normal`),n+=(e.width??1)*gp+_p})}),[[{code:`NumLock`},{code:`NumpadDivide`},{code:`NumpadMultiply`},{code:`NumpadSubtract`}],[{code:`Numpad7`},{code:`Numpad8`},{code:`Numpad9`},{code:`NumpadAdd`,width:1.1,tone:`cool`}],[{code:`Numpad4`},{code:`Numpad5`},{code:`Numpad6`},{code:`NumpadAddGhost`,width:1.1,tone:`cool`}],[{code:`Numpad1`},{code:`Numpad2`},{code:`Numpad3`},{code:`NumpadEnter`,width:1.1,tone:`cool`}],[{code:`Numpad0`,width:2.1},{code:`NumpadDecimal`},{code:`NumpadEnterGhost`,width:1.1,tone:`cool`}]].forEach((e,t)=>{let n=4.92-e.reduce((e,t)=>e+(t.width??1)*gp+_p,-_p)/2,r=yp+t*vp;e.forEach(e=>{mp(e.code===`NumpadAddGhost`?`NumpadAdd`:e.code===`NumpadEnterGhost`?`NumpadEnter`:e.code,n,r,e.width??1,e.tone??`normal`),n+=(e.width??1)*gp+_p})});var xp=new wn;xp.position.set(6.7,-2.96,4.35),Of.add(xp);var Sp=new wn;xp.add(Sp);var Cp=null,wp=[],Tp=new WeakMap;Yf.load(rf(`pc_mouse_type-r.glb`),e=>{let t=e.scene;t.traverse(e=>{e instanceof X&&(e.castShadow=!0,e.receiveShadow=!0,Array.isArray(e.material)?e.material.forEach(e=>{e instanceof Ja&&(e.envMapIntensity=1.25,e.roughness=Math.min(1,e.roughness*.96))}):e.material instanceof Ja&&(e.material.envMapIntensity=1.25,e.material.roughness=Math.min(1,e.material.roughness*.96)));let t=e.name.toLowerCase();(t.includes(`wheel`)||t.includes(`scroll`))&&(Cp=e),(t.includes(`left`)||t.includes(`right`)||t.includes(`button`)||t.includes(`click`))&&(wp.push(e),Tp.set(e,e.position.y))});let n=new Jn().setFromObject(t),r=new G,i=new G;n.getSize(r),n.getCenter(i);let a=1.95/Math.max(r.z,.001);t.scale.setScalar(a),t.position.sub(i.multiplyScalar(a)),t.position.y+=r.y*a/2+.02,t.rotation.y=Math.PI*1.9,t.rotation.x=-.02,Sp.add(t)},void 0,()=>{let e=new X(new Ia(.63,28,20),kf);e.scale.set(1.06,.62,1.3),e.castShadow=!0,e.position.y=.42,Sp.add(e)});var Ep=new Ja({color:2040877,roughness:.85,metalness:.08}),Dp=new X(new La(new _a([new G(.5,-3.1,4.9),new G(2.3,-3.2,5.6),new G(4.1,-3.05,5.05),new G(6,-2.95,4.35)]),48,.04,8,!1),Ep);Dp.castShadow=!0,Of.add(Dp);var Op=[`<!doctype html>`,`<html lang="en">`,`  <head>`,`    <title>HTML // Hope This Moons Later</title>`,`  </head>`,`  <body>`,`    <!-- type to mutate this memory -->`,`  </body>`,`</html>`],kp=`  <p class="signal">dial-up is alive</p>`,Ap=!0,jp=!1,Mp=0,Np=0,Pp=0,Fp=0,Ip=[];function Lp(){let e=Hf,{width:t,height:n}=Bf,r=t-104,i=n-84,a=e.createLinearGradient(0,0,0,n);a.addColorStop(0,`#cad8e2`),a.addColorStop(.5,`#9cc1d6`),a.addColorStop(1,`#5f8ea8`),e.fillStyle=a,e.fillRect(0,0,t,n);for(let r=0;r<n;r+=4)e.fillStyle=r%8==0?`rgba(0, 0, 0, 0.07)`:`rgba(255, 255, 255, 0.03)`,e.fillRect(0,r,t,2);e.fillStyle=`rgba(9, 23, 35, 0.8)`,e.fillRect(52,42,r,i),e.font=`26px "Courier New", monospace`,e.fillStyle=`#9ce8ff`,e.fillText(`C:/HTML/LOOP/index.html`,76,80),e.font=`23px "Courier New", monospace`,e.fillStyle=`#d7f9ff`;let o=[...Op.slice(-9),kp];if(o.forEach((t,n)=>{e.fillText(t,76,126+n*42)}),Ap){let t=e.measureText(kp);e.fillRect(83+t.width,100+o.length*42,14,22)}e.fillStyle=`rgba(255, 255, 255, 0.06)`,e.beginPath(),e.ellipse(t/2,n/2,t*.5,n*.44,0,0,Math.PI*2),e.fill(),Uf.needsUpdate=!0}function Rp(e){kp.length>45||(kp+=e,Ip.push(e),nf.textContent=Ip.slice(-20).join(``)||`none`,Lp())}window.addEventListener(`keydown`,e=>{e.code===`Space`&&e.preventDefault();let t=sp.get(e.code);if(t&&t.forEach(e=>{e.userData.press=1}),!e.repeat){if(e.key===`Backspace`){kp=kp.slice(0,-1),Lp();return}if(e.key===`Enter`){Op.push(kp),kp=`  `,nf.textContent=`ENTER`,Lp();return}e.key.length===1&&Rp(e.key)}}),window.addEventListener(`keyup`,e=>{let t=sp.get(e.code);t&&t.forEach(e=>{e.userData.press=0})}),window.addEventListener(`pointermove`,e=>{Pp=e.clientX/window.innerWidth-.5,Fp=e.clientY/window.innerHeight-.5}),window.addEventListener(`pointerdown`,()=>{jp=!0,wp.forEach(e=>{let t=Tp.get(e)??e.position.y;e.position.y=t-.01})}),window.addEventListener(`pointerup`,()=>{jp=!1,wp.forEach(e=>{let t=Tp.get(e)??e.position.y;e.position.y=t})}),window.addEventListener(`wheel`,e=>{Mp+=e.deltaY*4e-4}),window.addEventListener(`resize`,()=>{cf.aspect=window.innerWidth/window.innerHeight,cf.updateProjectionMatrix(),af.setSize(window.innerWidth,window.innerHeight),af.setPixelRatio(Math.min(window.devicePixelRatio,2)),Hp.setSize(window.innerWidth,window.innerHeight),Hp.setPixelRatio(Math.min(window.devicePixelRatio,2)),Vp.setSize(window.innerWidth,window.innerHeight)}),setInterval(()=>{Ap=!Ap,Lp()},460),Lp();var zp=new ys,Bp=new Zd(of,cf),Vp=new $d(new W(window.innerWidth,window.innerHeight),0,.2,1.02),Hp=new Xd(af);Hp.addPass(Bp),Hp.addPass(Vp);function Up(){let e=zp.getElapsedTime();cf.position.copy(lf),cf.lookAt(uf),cp.forEach(e=>{let t=Number(e.userData.restY)-Number(e.userData.press)*.08;e.position.y=Dt.lerp(e.position.y,t,.18)});let t=6.35+Pp*1.2,n=4.2+Fp*.9,r=Xf.position.x+13.4*.86/2+.95;xp.position.x=Dt.lerp(xp.position.x,Math.max(t,r),.1),xp.position.z=Dt.lerp(xp.position.z,n,.1),xp.rotation.z=Dt.lerp(xp.rotation.z,Pp*-.25,.1),xp.rotation.x=Dt.lerp(xp.rotation.x,(jp?.14:.03)+Fp*.12,.15),Np=Dt.lerp(Np,Mp,.14),Cp&&(Cp.rotation.x=Np*1.4),Sp.rotation.y=Np*.08;let i=.45+(Math.sin(e*2.2)*.5+.5)*.95,a=.5+(Math.sin(e*.55+.7)*.5+.5)*.7;wf.rotation.y+=5e-4,Ef.scale.setScalar(1+a*.08),Tf.opacity=.16+a*.12,Df.intensity=.78+a*.82,Af.emissiveIntensity=i,qf.intensity=1+(Math.sin(e*2.7+.5)*.5+.5)*1.05,gf.intensity=1.25+(Math.sin(e*2.4+1.8)*.5+.5)*.95,yf.intensity=1+(Math.sin(e*1.8+.9)*.5+.5)*.32,np.emissiveIntensity=.02,Cf.rotation.y+=8e-4,Cf.rotation.x=Math.sin(e*.1)*.06,Hp.render(),requestAnimationFrame(Up)}Up();