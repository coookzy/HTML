...
`;var cf=document.querySelector(`#scene`),lf=document.querySelector(`#typed-value`);if(!cf||!lf)throw Error(`Missing required DOM elements`);var uf=lf,df=e=>`/HTML/models/${e}`,ff=new Lu({canvas:cf,antialias:!0});ff.setPixelRatio(Math.min(window.devicePixelRatio,2)),ff.setSize(window.innerWidth,window.innerHeight),ff.shadowMap.enabled=!0,ff.shadowMap.type=2,ff.toneMapping=4,ff.toneMappingExposure=1.08;var pf=new Nn;pf.background=new Y(131844),pf.fog=new Mn(131844,20,42);var mf=new Ws(ff);pf.environment=mf.fromScene(new Bd,.6).texture,mf.dispose();var hf=new Uo(44,window.innerWidth/window.innerHeight,.1,100),gf=new G(0,2.15,17.7),_f=new G(0,-1.1,0);hf.position.copy(gf),hf.lookAt(_f);var vf=new Zo(10533119,.42);pf.add(vf);var yf=new jo(10406399,659222,.36);pf.add(yf);var bf=new Xo(14214911,.95);bf.position.set(7,10,6),bf.castShadow=!0,bf.shadow.mapSize.set(1024,1024),pf.add(bf);var xf=new qo(7256063,1.35,22);xf.position.set(-8,3,-8),pf.add(xf);var Sf=new Go(12180735,2.1,30,Math.PI/8,.42,1.05);Sf.position.set(14,5.1,2.8),Sf.castShadow=!0,Sf.shadow.mapSize.set(1024,1024),pf.add(Sf),pf.add(Sf.target);var Cf=new qo(4183807,1.35,18);Cf.position.set(12.5,.7,-6),pf.add(Cf);var wf=new Go(14740479,.58,34,Math.PI/5,.64,1.12);wf.position.set(0,10.8,3.2),wf.castShadow=!0,wf.shadow.mapSize.set(1024,1024),wf.target.position.set(0,-1.4,2.8),pf.add(wf),pf.add(wf.target);var Tf=new Go(16770239,.3,22,Math.PI/5,.56,1.25);Tf.position.set(-8.2,4.7,7.2),Tf.target.position.set(-.2,-2.7,4.4),pf.add(Tf),pf.add(Tf.target);var Ef=new Go(10147839,1.55,20,Math.PI/6,.7,1.1);Ef.position.set(11.8,2.2,2.3),pf.add(Ef),pf.add(Ef.target);var Df=new X(new oa(18,80),new Ja({color:658705,roughness:.92,metalness:.1}));Df.rotation.x=-Math.PI/2,Df.position.y=-4.05,Df.receiveShadow=!0,pf.add(Df);for(let e=0;e<3;e+=1){let t=new Ki(new oa(7+e*3.4,128),new Ni({color:2568509,transparent:!0,opacity:.5-e*.12}));t.rotation.x=-Math.PI/2,t.position.y=-3.98,pf.add(t)}var Of=new Dr,kf=new Float32Array(1800);for(let e=0;e<kf.length;e+=3)kf[e]=(Math.random()-.5)*65,kf[e+1]=(Math.random()-.1)*32,kf[e+2]=(Math.random()-.5)*65;Of.setAttribute(`position`,new fr(kf,3));var Af=new Qi(Of,new qi({color:15201791,size:.07,transparent:!0,opacity:.7}));pf.add(Af);var jf=new wn;jf.position.set(-15.5,8.8,-24),pf.add(jf);var Mf=new Vr({color:11127274,transparent:!0,opacity:.2}),Nf=new X(new Ia(3.4,32,32),Mf);jf.add(Nf);var Pf=new qo(13229567,.92,42);jf.add(Pf),new Vu().load(df(`luna_earths_companion.glb`),e=>{let t=e.scene;t.traverse(e=>{e instanceof X&&(e.castShadow=!1,e.receiveShadow=!1,Array.isArray(e.material)?e.material.forEach(e=>{e instanceof Ja&&(e.envMapIntensity=1.35,e.roughness=Math.min(1,e.roughness*1.05))}):e.material instanceof Ja&&(e.material.envMapIntensity=1.35,e.material.roughness=Math.min(1,e.material.roughness*1.05)))});let n=new Jn().setFromObject(t),r=new G,i=new G;n.getSize(r),n.getCenter(i);let a=5.2/Math.max(r.x,r.y,r.z,.001);t.scale.setScalar(a),t.position.sub(i.multiplyScalar(a)),t.rotation.y=Math.PI*.2,jf.add(t)},void 0,()=>{let e=new X(new Ia(1.7,40,40),new Ja({color:13489374,roughness:.95,metalness:.02,emissive:4938868,emissiveIntensity:.18}));jf.add(e)});var Ff=new wn;Ff.position.y=-.75,Ff.rotation.set(.02,0,0),pf.add(Ff);var If=new Ja({color:14276560,roughness:.76,metalness:.08}),Lf=new Ja({color:1779509,emissive:4183807,emissiveIntensity:.8,roughness:.3,metalness:.2}),Rf=new Ja({color:2041651,roughness:.4,metalness:.32}),zf=new Ja({color:922654,roughness:.45,metalness:.35}),Bf=new Ja({color:2107443,roughness:.48,metalness:.26}),Vf=new wn;Vf.position.set(0,2.34,-.82),Vf.scale.setScalar(1.14),Ff.add(Vf);var Hf=new X(new aa(9.6,5.8,.55),Rf);Hf.castShadow=!0,Vf.add(Hf);var Uf=new X(new aa(8.9,5.15,.14),zf);Uf.position.set(0,0,.29),Uf.castShadow=!0,Vf.add(Uf);var Wf=new wn;Wf.position.set(0,-3.3,-.05),Vf.add(Wf);var Gf=new X(new aa(.75,2.15,.52),zf);Gf.castShadow=!0,Wf.add(Gf);var Kf=new X(new sa(1.8,2.1,.24,40),zf);Kf.position.set(0,-1.2,.7),Kf.castShadow=!0,Wf.add(Kf);var qf=document.createElement(`canvas`);qf.width=1280,qf.height=720;var Jf=qf.getContext(`2d`);if(!Jf)throw Error(`2D context unavailable`);var Yf=Jf,Xf=new ta(qf);Xf.colorSpace=ze,Xf.minFilter=s;var Zf=new X(new Fa(8.42,4.73),new Vr({map:Xf,toneMapped:!1}));Zf.position.set(0,0,.48),Zf.renderOrder=2,Vf.add(Zf);var Qf=new wn;Qf.position.set(10.95,-1.62,-3.2),Qf.rotation.y=-.34,Qf.scale.setScalar(1.1),Ff.add(Qf),Sf.target=Qf;var $f=new wn;Qf.add($f);var ep=new qo(5692927,1.45,14);ep.position.set(-.8,1.1,.9),Qf.add(ep);var tp=new X(new oa(1.55,28),new Vr({color:329481,transparent:!0,opacity:.42}));tp.rotation.x=-Math.PI/2,tp.position.set(0,-3.45,0),Qf.add(tp);var np=new Vu;np.load(df(`pc_model.glb`),e=>{let t=e.scene,n=Math.PI*.86;t.traverse(e=>{e instanceof X&&(e.castShadow=!0,e.receiveShadow=!0,Array.isArray(e.material)?e.material.forEach(e=>{e instanceof Ja&&(e.envMapIntensity=1.7,e.roughness=Math.min(1,e.roughness*.92),e.metalness=Math.min(1,e.metalness*.95),e.color.multiplyScalar(1.1))}):e.material instanceof Ja&&(e.material.envMapIntensity=1.7,e.material.roughness=Math.min(1,e.material.roughness*.92),e.material.metalness=Math.min(1,e.material.metalness*.95),e.material.color.multiplyScalar(1.1)))});let r=new Jn().setFromObject(t),i=new G,a=new G;r.getSize(i),r.getCenter(a);let o=7.8/Math.max(i.y,.001);t.scale.setScalar(o),t.position.sub(a.multiplyScalar(o)),t.position.y+=-3.22+i.y*o/2,t.rotation.y=n,$f.add(t)},void 0,e=>{console.error(`Failed to load PC GLB model:`,e);let t=new X(new aa(3.3,7.2,6),Bf);t.castShadow=!0,t.position.y=-.2,$f.add(t)}),Ef.target=Qf;var rp=new wn;rp.position.set(0,-3.06,4.68),rp.rotation.x=.08,rp.scale.setScalar(.86),Ff.add(rp);var ip=new Ja({color:1711914,roughness:.52,metalness:.26}),ap=new Ja({color:2765120,roughness:.45,metalness:.22}),op=new X(new aa(13.4,.6,5.35),ip);op.castShadow=!0,rp.add(op);var sp=new X(new aa(12.75,.08,4.75),ap);sp.position.set(0,.34,-.08),rp.add(sp);var cp=new X(new aa(13.25,.22,.3),ap);cp.position.set(0,.2,2.48),rp.add(cp);var lp=new Ja({color:856860,emissive:4048127,emissiveIntensity:.02,roughness:.4,metalness:.12}),up=new X(new aa(12.25,.05,.08),lp);up.position.set(0,-.2,2.62),rp.add(up);var dp=new Ja({color:12173775,roughness:.62,metalness:.04}),fp=new Ja({color:12751195,roughness:.58,metalness:.06}),pp=new Ja({color:2841753,roughness:.54,metalness:.08}),mp=new Map,hp=[],gp=new Map;function _p(e){return e===`warm`?fp:e===`cool`?pp:dp}function vp(e){return nf[e]??e.replace(`Key`,``)}function yp(e,t){let n=`${t}:${e}`,r=gp.get(n);if(r)return r;let i=document.createElement(`canvas`);i.width=256,i.height=256;let a=i.getContext(`2d`);if(!a)return _p(t);let o=t===`warm`?`#c99863`:t===`cool`?`#2f67ac`:`#bcc5d3`,c=t===`cool`?`#f2f8ff`:`#1f2a38`;a.fillStyle=o,a.fillRect(0,0,256,256),a.strokeStyle=`rgba(255, 255, 255, 0.12)`,a.lineWidth=6,a.strokeRect(9,9,238,238),a.fillStyle=c,a.font=`bold 42px "Segoe UI", Arial, sans-serif`,a.textAlign=`center`,a.textBaseline=`middle`;let l=e.split(`
`);l.length===1?a.fillText(l[0],128,132):(a.font=`bold 36px "Segoe UI", Arial, sans-serif`,l.forEach((e,t)=>{a.fillText(e,128,106+t*54)}));let u=new ta(i);u.colorSpace=ze,u.anisotropy=ff.capabilities.getMaxAnisotropy(),u.minFilter=s;let d=new Ja({map:u,roughness:.38,metalness:.08});return gp.set(n,d),d}function bp(e,t,n,r=1,i=`normal`){let a=r*.45,o=_p(i),s=[o,o,yp(vp(e),i),o,o,o],c=new X(new aa(a,.16,.38),s);c.castShadow=!0,c.position.set(t+a/2,.43,n),c.userData.restY=c.position.y,c.userData.press=0,hp.push(c);let l=mp.get(e)??[];l.push(c),mp.set(e,l),rp.add(c)}rf.forEach((e,t)=>{let n=sf.primaryStartX,r=sf.rowStart+t*sf.rowDepth;e.forEach(e=>{bp(e.code,n,r,e.width??1,e.tone??`normal`),n+=(e.width??1)*sf.unit+sf.gap})}),af.forEach((e,t)=>{let n=e.reduce((e,t)=>e+(t.width??1)*sf.unit+sf.gap,-sf.gap),r=sf.navCenterX-n/2,i=sf.rowStart+t*sf.rowDepth;e.forEach(e=>{bp(e.code,r,i,e.width??1,e.tone??`normal`),r+=(e.width??1)*sf.unit+sf.gap})}),of.forEach((e,t)=>{let n=e.reduce((e,t)=>e+(t.width??1)*sf.unit+sf.gap,-sf.gap),r=sf.numpadCenterX-n/2,i=sf.rowStart+t*sf.rowDepth;e.forEach(e=>{bp(e.code===`NumpadAddGhost`?`NumpadAdd`:e.code===`NumpadEnterGhost`?`NumpadEnter`:e.code,r,i,e.width??1,e.tone??`normal`),r+=(e.width??1)*sf.unit+sf.gap})});var xp=new wn;xp.position.set(6.7,-2.96,4.35),Ff.add(xp);var Sp=new wn;xp.add(Sp);var Cp=null,wp=[],Tp=new WeakMap;np.load(df(`pc_mouse_type-r.glb`),e=>{let t=e.scene;t.traverse(e=>{e instanceof X&&(e.castShadow=!0,e.receiveShadow=!0,Array.isArray(e.material)?e.material.forEach(e=>{e instanceof Ja&&(e.envMapIntensity=1.25,e.roughness=Math.min(1,e.roughness*.96))}):e.material instanceof Ja&&(e.material.envMapIntensity=1.25,e.material.roughness=Math.min(1,e.material.roughness*.96)));let t=e.name.toLowerCase();(t.includes(`wheel`)||t.includes(`scroll`))&&(Cp=e),(t.includes(`left`)||t.includes(`right`)||t.includes(`button`)||t.includes(`click`))&&(wp.push(e),Tp.set(e,e.position.y))});let n=new Jn().setFromObject(t),r=new G,i=new G;n.getSize(r),n.getCenter(i);let a=1.95/Math.max(r.z,.001);t.scale.setScalar(a),t.position.sub(i.multiplyScalar(a)),t.position.y+=r.y*a/2+.02,t.rotation.y=Math.PI*1.9,t.rotation.x=-.02,Sp.add(t)},void 0,()=>{let e=new X(new Ia(.63,28,20),If);e.scale.set(1.06,.62,1.3),e.castShadow=!0,e.position.y=.42,Sp.add(e)});var Ep=new Ja({color:2040877,roughness:.85,metalness:.08}),Dp=new X(new La(new _a([new G(.5,-3.1,4.9),new G(2.3,-3.2,5.6),new G(4.1,-3.05,5.05),new G(6,-2.95,4.35)]),48,.04,8,!1),Ep);Dp.castShadow=!0,Ff.add(Dp);var Op=[...ef],kp=tf,Ap=!0,jp=!1,Mp=0,Np=0,Pp=0,Fp=0,Ip=[];function Lp(){let e=Yf,{width:t,height:n}=qf,r=t-104,i=n-84,a=e.createLinearGradient(0,0,0,n);a.addColorStop(0,`#cad8e2`),a.addColorStop(.5,`#9cc1d6`),a.addColorStop(1,`#5f8ea8`),e.fillStyle=a,e.fillRect(0,0,t,n);for(let r=0;r<n;r+=4)e.fillStyle=r%8==0?`rgba(0, 0, 0, 0.07)`:`rgba(255, 255, 255, 0.03)`,e.fillRect(0,r,t,2);e.fillStyle=`rgba(9, 23, 35, 0.8)`,e.fillRect(52,42,r,i),e.font=`26px "Courier New", monospace`,e.fillStyle=`#9ce8ff`,e.fillText(`C:/HTML/LOOP/index.html`,76,80),e.font=`23px "Courier New", monospace`,e.fillStyle=`#d7f9ff`;let o=[...Op.slice(-9),kp];if(o.forEach((t,n)=>{e.fillText(t,76,126+n*42)}),Ap){let t=e.measureText(kp);e.fillRect(83+t.width,100+o.length*42,14,22)}e.fillStyle=`rgba(255, 255, 255, 0.06)`,e.beginPath(),e.ellipse(t/2,n/2,t*.5,n*.44,0,0,Math.PI*2),e.fill(),Xf.needsUpdate=!0}function Rp(e){kp.length>45||(kp+=e,Ip.push(e),uf.textContent=Ip.slice(-20).join(``)||`none`,Lp())}window.addEventListener(`keydown`,e=>{e.code===`Space`&&e.preventDefault();let t=mp.get(e.code);if(t&&t.forEach(e=>{e.userData.press=1}),!e.repeat){if(e.key===`Backspace`){kp=kp.slice(0,-1),Lp();return}if(e.key===`Enter`){Op.push(kp),kp=`  `,uf.textContent=`ENTER`,Lp();return}e.key.length===1&&Rp(e.key)}}),window.addEventListener(`keyup`,e=>{let t=mp.get(e.code);t&&t.forEach(e=>{e.userData.press=0})}),window.addEventListener(`pointermove`,e=>{Pp=e.clientX/window.innerWidth-.5,Fp=e.clientY/window.innerHeight-.5}),window.addEventListener(`pointerdown`,()=>{jp=!0,wp.forEach(e=>{let t=Tp.get(e)??e.position.y;e.position.y=t-.01})}),window.addEventListener(`pointerup`,()=>{jp=!1,wp.forEach(e=>{let t=Tp.get(e)??e.position.y;e.position.y=t})}),window.addEventListener(`wheel`,e=>{Mp+=e.deltaY*4e-4}),window.addEventListener(`resize`,()=>{hf.aspect=window.innerWidth/window.innerHeight,hf.updateProjectionMatrix(),ff.setSize(window.innerWidth,window.innerHeight),ff.setPixelRatio(Math.min(window.devicePixelRatio,2)),Hp.setSize(window.innerWidth,window.innerHeight),Hp.setPixelRatio(Math.min(window.devicePixelRatio,2)),Vp.setSize(window.innerWidth,window.innerHeight)}),setInterval(()=>{Ap=!Ap,Lp()},460),Lp();var zp=new ys,Bp=new Zd(pf,hf),Vp=new $d(new W(window.innerWidth,window.innerHeight),0,.2,1.02),Hp=new Xd(ff);Hp.addPass(Bp),Hp.addPass(Vp);function Up(){let e=zp.getElapsedTime();hf.position.copy(gf),hf.lookAt(_f),hp.forEach(e=>{let t=Number(e.userData.restY)-Number(e.userData.press)*.08;e.position.y=Dt.lerp(e.position.y,t,.18)});let t=6.35+Pp*1.2,n=4.2+Fp*.9,r=rp.position.x+13.4*.86/2+.95;xp.position.x=Dt.lerp(xp.position.x,Math.max(t,r),.1),xp.position.z=Dt.lerp(xp.position.z,n,.1),xp.rotation.z=Dt.lerp(xp.rotation.z,Pp*-.25,.1),xp.rotation.x=Dt.lerp(xp.rotation.x,(jp?.14:.03)+Fp*.12,.15),Np=Dt.lerp(Np,Mp,.14),Cp&&(Cp.rotation.x=Np*1.4),Sp.rotation.y=Np*.08;let i=.45+(Math.sin(e*2.2)*.5+.5)*.95,a=.5+(Math.sin(e*.55+.7)*.5+.5)*.7;jf.rotation.y+=5e-4,Nf.scale.setScalar(1+a*.08),Mf.opacity=.16+a*.12,Pf.intensity=.78+a*.82,Lf.emissiveIntensity=i,ep.intensity=1+(Math.sin(e*2.7+.5)*.5+.5)*1.05,Cf.intensity=1.25+(Math.sin(e*2.4+1.8)*.5+.5)*.95,Ef.intensity=1+(Math.sin(e*1.8+.9)*.5+.5)*.32,lp.emissiveIntensity=.02,Af.rotation.y+=8e-4,Af.rotation.x=Math.sin(e*.1)*.06,Hp.render(),requestAnimationFrame(Up)}Up();